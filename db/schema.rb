...
ActiveRecord::Schema.define(version: 2022_06_08_085011) do
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.integer "associated_category_id"
    t.integer "parent_category_id"
    t.bigint "associated_category_id_id"
    t.bigint "parent_category_id_id"
    t.index ["associated_category_id_id"], name: "index_categories_on_associated_category_id_id"
  ...
  add_foreign_key "categories", "categories", column: "associated_category_id_id"
  add_foreign_key "categories", "categories", column: "parent_category_id_id"
